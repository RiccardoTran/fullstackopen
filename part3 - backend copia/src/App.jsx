...
const fetchPersons = async () => {
  try {
    const url = `https://fsopart3ricky.fly.dev/api/persons`
    const response = await axios.get(url)
    console.log(response.data)
...
useEffect(fetchPersons,[])
  ...
  const hook2  = () => { //add name
    axios
    .post("https://fsopart3ricky.fly.dev/api/persons/",nameObject)
    .then(response => {
  ...
  const hook3 = (nameObject) => { //replace number
    ...
    const url = `https://fsopart3ricky.fly.dev/api/persons/${idReplace}`
    console.log(url)
    axios
      .put(url,nameObject)
      .then(response => {
  ...
  const deletePerson = id => {
    const url = `https://fsopart3ricky.fly.dev/api/persons/${id}`
